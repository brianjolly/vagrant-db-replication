...
node.set_unless['mysql']['server_debian_password'] = 'root' #secure_password
node.set_unless['mysql']['server_root_password']   = 'root' #secure_password
node.set_unless['mysql']['server_repl_password']   = 'root' #secure_password
